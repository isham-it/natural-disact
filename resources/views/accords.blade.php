        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3><p>{{ $accord->title}}</p></h3>
            </div>
            <div class="solu_description">
              <p id="offer_description">
              {{ $accord->title}} It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its
              </p>
              <a href="{{ route('details.accord', [$accord->id])}}"><button type="button" class="read_more_btn">Read More</button></a>
