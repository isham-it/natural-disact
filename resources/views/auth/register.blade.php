                ...
                <div class="row">
                    ...
                    placeholder="Enter your city"/>
                                            ...
                                            <div>
                                                ...
                                                <select class="cityselect" for="city" :value="__('CITY')" class="titleForm" id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city')" required autofocus>
                                            ...
                                            <div>
                                                ...
                                                <x-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" required autofocus placeholder="Enter your phone number" />
                                            </div>
