...
<!---->
    ...
    <a href="{{ url('new-ask') }}"><button id="add_button" type="button" class="read_more_btn">ADD A HELP REQUEST</button></a>
</div>
    <br>
    @foreach ($asks as $ask)
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              {{ $ask->title}} It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its
              </p>
              <a href="{{ route('details.ask', [$ask->id])}}"><button type="button" class="read_more_btn">Read More</button></a>
              <a href="{{ route('accept.accord', [$ask->id, $ask->title])}}"><button type="button" class="read_more_btn">Accept</button></a>
