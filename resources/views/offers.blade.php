...
<body id="offerBody">
    ...
    <a href="{{ url('new-offer') }}"><button id="add_button" type="button" class="read_more_btn">ADD AN OFFER</button></a>
</div>
    <br>
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3><p>{{ $offer->title}}</p></h3>
            </div>
            <div class="solu_description">
              <p id="offer_description">
              {{ $offer->title}} It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its
              </p>
              <a href="{{ route('details.offer', [$offer->id])}}"><button type="button" class="read_more_btn">Read More</button></a>
              <a href="{{ route('accept.accord', [$offer->id, $offer->title])}}"><button type="button" class="read_more_btn">Accept</button></a>
